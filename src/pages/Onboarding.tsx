...
import { FileSearch, Bot, Key, CheckCircle2, ArrowRight, Loader2 } from 'lucide-react';
...
export default function Onboarding() {
  ...
  const verifyApiKey = async () => {
    ...
    // For demo, accept any key that's at least 10 characters
    if (apiKey.length >= 10) {
      updateSettings({
        ...
        {['welcome', 'provider', 'apikey', 'complete'].map((s, i) => (
          <div
            ...
            className={cn(
              ...
              ['welcome', 'provider', 'apikey', 'complete'].indexOf(step) >= i
                ? "bg-primary"
                : "bg-muted"
            )}
          />
      ...
      <div className="flex-1 flex flex-col p-6">
        ...
        {step === 'welcome' && (
          <div className="flex-1 flex flex-col animate-fade-in">
            <div className="flex-1 flex flex-col items-center justify-center text-center">
              <div className="w-24 h-24 rounded-3xl upload-button-gradient flex items-center justify-center shadow-glow mb-8 animate-bounce-soft">
                <FileSearch className="w-12 h-12 text-primary-foreground" />
              </div>
          ...
          <div className="flex-1 flex flex-col animate-fade-in">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">
                Select your preferred AI service for document analysis and chat.
              </p>
            </div>
            ...
            <Button onClick={() => setStep('apikey')} size="lg" className="w-full gap-2 mt-6">
              Continue
              <ArrowRight className="w-5 h-5" />
            </Button>
          </div>
        ...
        {step === 'apikey' && (
          <div className="flex-1 flex flex-col animate-fade-in">
            <div className="mb-8">
              ...
              <p className="text-muted-foreground">
                Enter your {providers.find(p => p.id === selectedProvider)?.name} API key to enable AI features.
              </p>
            </div>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-2xl bg-secondary">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      <p className="font-semibold">{providers.find(p => p.id === selectedProvider)?.name}</p>
        ...
        {step === 'complete' && (
          <div className="flex-1 flex flex-col items-center justify-center text-center animate-fade-in">
            ...
            <p className="text-lg text-muted-foreground max-w-xs mb-12">
              Start capturing and organizing your documents with SnapKeep.
            </p>
            <Button onClick={completeOnboarding} size="lg" className="w-full gap-2">
              Start Using SnapKeep
              <ArrowRight className="w-5 h-5" />
            </Button>
          </div>
        )}
